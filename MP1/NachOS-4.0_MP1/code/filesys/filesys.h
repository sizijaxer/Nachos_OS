...
/*============================= 10/15 edit =================================*/
    OpenFileId OpenAFile(char *name) {
        int fileDescriptor = OpenForReadWrite(name,FALSE);///id start from 6 , I dont know why //valid: id = 6~25
        if(fileDescriptor==-1 || fileDescriptor>25)return -1; ///invalid or exceed 20 files 
        OpenFileTable[fileDescriptor-6] = new OpenFile(fileDescriptor);
        return fileDescriptor;
    }
    int WriteFile(char *buffer, int size, OpenFileId id){
        if(OpenFileTable[id-6]==NULL)return -1;
...
/*============================== end edit ================================*/
    ...
    OpenFile *OpenFileTable[20]; ///目前openned的files 10/15
};
