...
#define SC_Create	4
#define SC_Remove       5
#define SC_Open	6 /*===============10/15 remove commenent============*/
#define SC_Read	7 /*===============10/15 remove commenent============*/
#define SC_Write	8 /*===============10/15 remove commenent============*/
#define SC_Seek         9
#define SC_Close	10 /*===============10/15 remove commenent============*/
